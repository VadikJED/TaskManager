...
using TaskManager.Desktop.Repositories;
using TaskManager.Desktop;
using Xunit;

namespace TaskManager.Desktop.Tests.ViewModels;
...
public class MainWindowViewModelTests
{
  ...
  public async Task AddTaskAsync_WhenTitleIsEmpty_ShouldNotSaveToRepository()
  {
    ...
    _mockRepository.Verify(
        repo => repo.AddAsync(It.IsAny<Models.TaskItem>()),
        Times.Never,
  ...
  public async Task AddTaskAsync_WhenTitleIsValid_ShouldSaveToRepository()
  {
    ...
    var createdTask = new Models.TaskItem
    {
      Id = Guid.NewGuid(),
      Title = expectedTitle,
      IsCompleted = false,
    ...
    _mockRepository
        .Setup(repo => repo.AddAsync(It.IsAny<Models.TaskItem>()))
    ...
    _mockRepository.Verify(
        repo => repo.AddAsync(It.Is<Models.TaskItem>(task =>
